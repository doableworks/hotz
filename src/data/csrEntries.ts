...
The 5th Edition marks an important milestone as it moves to Vijay Garhi at Jaigarh Fort—an austere, historic structure newly opened to the public. Once believed to have been a jail and later an armory, Vijay Garhi's stark architecture now becomes a powerful setting for contemporary artworks. This transformation reflects Saath Saath Arts' continued mission to activate heritage spaces and foster meaningful engagement between India's cultural past and its modern creative expression.

Curated by Peter Nagy, the exhibition brings together a diverse roster of leading contemporary artists showcasing works in bronze, ceramic, fiber, stone, stainless steel, and more. The Sculpture Park continues its tradition of being theme-free, offering visitors the freedom to explore, interpret, and experience art without boundaries.

Supported by the Jaigarh Public Charitable Trust and Jaipur Centre for Art (JCA), this edition strengthens Jaipur's growing presence as a global hub for contemporary art. With Saath Saath Arts at its core, the initiative stands as a testament to how heritage, creativity, and community can converge to create powerful cultural experiences.`,
    projectNote: `Saath Saath Arts Foundation creates cultural experiences that connect people, places, and contemporary art. Our projects activate historic sites, support artistic innovation, and open new pathways for public engagement with sculpture, installations, and interdisciplinary practices.
...
The Academy reflects this mission through its integrated approach to education, supporting both mainstream and disabled children in a nurturing, inclusive environment. As part of a wider network of philanthropic initiatives, the school stands as a testament to the Society&apos;s commitment to accessible education, vocational development, and holistic community support.`,
    institutionalBackground: `Servants of the People Society

Regd No: S - 667 of 1953 - 1954 under the Societies Registration Act of 1860
