    ...
    <>
      ...
      <div className="px-5 lg:px-56 mt-7 lg:mt-20">
        ...
        <div className="mt-10 lg:text-base text-sm">
          ...
          nihil voluptates similique nesciunt veritatis harum, iste fugit veniam
          illo a modi tempora nulla maiores expedita repudiandae unde quibusdam
          assumenda, cumque itaque officiis? Eaque deleniti fugiat vero beatae
          consectetur qui quos id, voluptatum nostrum asperiores recusandae
          consequuntur illo nesciunt unde eum voluptas rerum quis, est commodi
          optio labore eveniet! Eos eum sequi saepe, nobis reprehenderit, vel,
          labore suscipit quaerat aspernatur cumque facere! Minima tempora a
          similique soluta architecto dolores magni eius deserunt quod, nemo ad
          illum labore omnis repellendus veniam possimus voluptatum adipisci
          quibusdam nihil veritatis. Minus eum a blanditiis!
        </div>
